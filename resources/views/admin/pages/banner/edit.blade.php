                    ...
                    <div class="col-md-12">
                        <div class="add-course-header pb-0 mb-3">
                            ...
                            <div class="add-course-btns">
                                <ul class="nav">
                                    <li>
                                        <a href="{{ route('admin.banner.index') }}" class="btn btn-black">Back to
                                            Banner</a>
                                    </li>
                                    <li>
                                            ...
                                            <div class="course-name d-flex align-items-center">
                                                <div class="form-group">
                                                    <div class=" profile-image-circle">
                                                        <img id="ImagePreview" class="h-100 Profile-img"
                                ...
                                <form action="#">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <img id="ImagePreview" class="h-50 Profile-img" width="350px" height="350px"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select select country-select select2-hidden-accessible"
                                                    ...
                                                    <option value="0"
                                                        @if ($banner->status == 0) selected @endif>Inactive</option>
                                                </select>
                                            </div>
                                        </div>
