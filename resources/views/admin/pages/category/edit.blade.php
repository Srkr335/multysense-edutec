                    ...
                    <div class="col-md-12">
                        <div class="add-course-header pb-0 mb-3">
                            ...
                            <div class="add-course-btns">
                                <ul class="nav">
                                    <li>
                                        <a href="{{ route('admin.category.index') }}" class="btn btn-black">Back to
                                            Category</a>
                                    </li>
                                    <li>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-select select country-select select2-hidden-accessible"
                                                    ...
                                                    aria-hidden="true">
                                                    <option value="1"
                                                        @if ($category->status == 1) selected @endif>Active</option>
                                                    <option value="0"
                                                        @if ($category->status == 0) selected @endif>Inactive</option>
                                                </select>
                                            </div>
                                        </div>
