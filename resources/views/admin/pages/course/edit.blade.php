                                        ...
                                        <div class=" row add-course-form col-md-12">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="relative-form">
                                                    <span id="cover_image_name"><input type="text"
                                                            class="border-0 bg-white" disabled placeholder="No file choose">
                                                    </span>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="relative-form">
                                                    <span id="main_image_name"><input type="text"
                                                            class="border-0 bg-white" disabled
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input id="youtube_url" name="youtube_url" type="text"
                                                    value="{{ @$course->courcePlaylist->youtube_url }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input id="url_1" name="url_1" type="text" class="form-control"
                                                    value="{{ @$course->courcePlaylist->url_1 }}"
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input id="url_2" name="url_2" type="text" class="form-control"
                                                    value="{{ @$course->courcePlaylist->url_2 }}"
                                                    placeholder="Extra URL">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label class="add-course-label">Extra URL</label>
                                                <input id="url_3" name="url_3" type="text" class="form-control"
                                                    value="{{ @$course->courcePlaylist->url_3 }}"
                                                    placeholder="Extra URL">
                                            </div>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" id="yes"
                                                        name="is_top_rated" value="1"
                                                        @if ($course->is_top_rated == 1) checked @endif /><label
                                                        class="form-check-label" for="yes">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" id="no"
                                                        name="is_top_rated" value="0"
                                                        @if ($course->is_top_rated == 0) checked @endif /><label
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" id="yes"
                                                        ...
                                                        @if ($course->is_trending == 1) checked @endif /><label
                                                        class="form-check-label" for="yes">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" id="no"
                                                        name="is_trending" value="0"
                                                        @if ($course->is_trending == 0) checked @endif /><label
                                                        class="form-check-label" for="no">No</label>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" id="yes"
                                                        name="is_most_purchased" value="1"
                                                        @if ($course->is_most_purchased == 1) checked @endif /><label
                                                        class="form-check-label" for="yes">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" id="no"
                                                        name="is_most_purchased" value="0"
                                                        @if ($course->is_most_purchased == 0) checked @endif /><label
                                                        class="form-check-label" for="no">No</label>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" id="yes"
                                                        name="is_newly_added" value="1"
                                                        @if ($course->is_newly_added == 1) checked @endif /><label
                                                        class="form-check-label" for="yes">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" id="no"
                                                        name="is_newly_added" value="0"
                                                        @if ($course->is_newly_added == 0) checked @endif /><label
                                                        class="form-check-label" for="no">No</label>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" id="yes"
                                                        ...
                                                        @if ($course->is_free == 1) checked @endif /><label
                                                        class="form-check-label" for="yes">Yes</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" id="no"
                                                        name="is_free" value="0"
                                                        @if ($course->is_free == 0) checked @endif /><label
                                                        class="form-check-label" for="no">No</label>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-6">
