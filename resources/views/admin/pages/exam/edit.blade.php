...
@section('content')
    <div class="container" style="transform: none;">
        <div class="row" style="transform: none;">
            ...
            <form action="{{ route('admin.exam.update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter your exam Name"
                                                name="exam_name" value="{{$exam->exam_name}}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select select country-select select2-hidden-accessible"
                                                    ...
                                                    <option value="{{$center->id}}"{{$exam->exam_centre_id == $center->id ? 'selected' : ''}}>{{$center->name}}</option>
                                                    @endforeach    
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" id="checkAllModules" onchange="toggleAllCheckboxes(this)">
                                            <br>
                                            @foreach($modules as $module)
                                            @if($decodedModulesIds)
                                            <input type="checkbox" name="modules[]" value="{{ $module->id }}" class="module-checkbox"
                                            {{ in_array($module->id, $decodedModulesIds) ? 'checked' : '' }}>
                                            @else
                                            <input type="checkbox" name="modules[]" value="{{ $module->id }}" class="module-checkbox">
                                            @endif
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" placeholder="Enter marks"
                                                name="exam_mark" value="{{$exam->marks}}">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="form-control-label">Hours</label>
                                            <input type="number" class="form-control" placeholder="Enter hours" name="hours" value="{{$hours}}">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="form-control-label">Minutes</label>
                                            <input type="number" class="form-control" placeholder="Enter minutes" name="minutes" value="{{$minutes}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="" class="form-control" name="exam_date" placeholder="dd/mm/yyyy" value="{{$exam->exam_date}}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder=""
                                                name="per_questions_weight" value="{{$exam->question_weightage}}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
